...
<div class="py-6">
    <div class="max-w-3xl mx-auto">
        ...
        <div class="bg-white shadow-md px-6 py-8 sm:rounded-lg">
            <form action="{{ route('hotel_admin.panel.rooms.update', $room->room_id) }}" method="POST">
                @csrf
                @method('PUT')
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                    ...
                    <div class="md:col-span-2" x-data="{
                        photos: JSON.parse('{{ json_encode(old('photos', $room->photos_json ?? [])) }}' || '[]'),
                        newPhotoUrlInput: ''
                    }">
                    ...
                    <div class="md:col-span-2" x-data="{
                        videos: {{ json_encode(old('videos', $room->videos_json ?? [])) }},
                        newVideoUrlInput: ''
                    }">
