            ...
            <form action="{{ route('admin.panel.hotels.rooms.store', $hotel->hotel_id) }}" method="POST">
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                    ...
                    <div class="md:col-span-2" x-data="{
                        photos: {{ json_encode(old('photos', [])) }}, // This holds the array of URLs
                        newPhotoUrlInput: '' // This holds the current input for adding a new URL
                    }">
                        ...
                        <div class="mb-4">
                            ...
                            <x-input-error class="mt-2" :messages="$errors->get('photos.*')" /> {{-- For individual photo URL errors --}}
                        </div>
                    </div>

                    {{-- Videos Management - only URLs --}}
                    <div class="md:col-span-2" x-data="{
                        videos: {{ json_encode(old('videos', [])) }}, // This holds the array of URLs
                        newVideoUrlInput: '' // This holds the current input for adding a new URL
                    }">
                        ...
                        <div class="mb-4">
                            ...
                            <x-input-error class="mt-2" :messages="$errors->get('videos.*')" /> {{-- For individual video URL errors --}}
                        </div>
                    </div>
